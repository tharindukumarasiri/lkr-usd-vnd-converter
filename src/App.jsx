...
import { X, Plus, DollarSign, Undo } from 'lucide-react';

// Utility for formatting numbers with spaces
...
function App() {
  ...
  const quickAmounts = [500000, 200000, 100000, 50000, 20000, 10000, 5000, 2000, 1000, 500, 200, 100];
          ...
          <div className="mb-6">
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="Enter rate (e.g., 300)"
              ...
              {tempTransactions.map((transaction, index) => (
                <div key={index} className="flex gap-3 items-start bg-gray-50 p-4 rounded-lg">
                  <div className="flex-1">
                    <label className="block text-xs font-semibold text-gray-600 mb-1">VND Rate</label>
                    <input
                      type="number"
